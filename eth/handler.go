...
type handlerConfig struct {
	...
	HistoryMode    history.HistoryMode    // Chain history retention mode
}
...
func newHandler(config *handlerConfig) (*handler, error) {
	...
	h.downloader = downloader.New(config.Database, config.Sync, h.eventMux, h.chain, h.removePeer, h.enableSyncedFeatures, config.HistoryMode)
