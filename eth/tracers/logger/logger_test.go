...
func TestStructLogMarshalingOmitEmpty(t *testing.T) {
	tests := []struct {
		...
		{"empty err and no fields", &StructLog{},
			`{"pc":0,"op":0,"gas":"0","gasCost":"0","memSize":0,"stack":null,"depth":0,"refund":0,"opName":"STOP"}`},
		{"with err", &StructLog{Err: errors.New("this failed")},
			`{"pc":0,"op":0,"gas":"0","gasCost":"0","memSize":0,"stack":null,"depth":0,"refund":0,"opName":"STOP","error":"this failed"}`},
		{"with mem", &StructLog{Memory: make([]byte, 2), MemorySize: 2},
			`{"pc":0,"op":0,"gas":"0","gasCost":"0","memory":"0x0000","memSize":2,"stack":null,"depth":0,"refund":0,"opName":"STOP"}`},
